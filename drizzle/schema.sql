...
-- Storefront identity and support details (migration 0011)
...
-- Bot email WR→buyer (migrasi 0036): log idempoten forward email WR.
-- Forwarder (Apps Script label WR-INGEST) POST ke /api/webhook/wr-email;
-- gmail_message_id UNIQUE mencegah kirim ganda ke buyer saat retry.
