...
export const products: Product[] = [
  ...
  { id: "p3", slug: "ai-gateway-1jt-token", name: "AI Gateway 1 Juta Token", description: "Gateway hemat GPT-4o, Claude, Gemini — 1 key untuk semua model.", price: 75000, categorySlug: "ai-gateway", image: "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=600&h=450&fit=crop", popular: true, soldCount: 512, stock: 999 },
  ...
  { id: "p9", slug: "ai-gateway-5jt-token", name: "AI Gateway 5 Juta Token", description: "Untuk developer & agency — 5jt token, key anti-limit.", price: 299000, comparePrice: 500000, categorySlug: "ai-gateway", image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=600&h=450&fit=crop", soldCount: 64, stock: 40 },
  { id: "p10", slug: "adobe-cc-1-bulan", name: "Adobe CC All Apps 1 Bulan", description: "Photoshop, Illustrator, Premiere — full.", price: 150000, comparePrice: 800000, categorySlug: "tools-pro", image: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=600&h=450&fit=crop", soldCount: 45, stock: 12 },
