...
export default function CaraOrderPage() {
  return <main className="mx-auto max-w-[920px] px-4 py-10 sm:px-6 sm:py-14">
    ...
    <div className="mt-8 flex flex-wrap gap-3"><Link href="/#katalog" className="inline-flex h-11 items-center rounded-full bg-white px-6 text-sm font-bold text-[#080C1E]">Lihat katalog</Link><Link href="/lacak-pesanan" className="inline-flex h-11 items-center rounded-full bg-[#00E5FF] px-6 text-sm font-bold text-[#080C1E]">Lacak pesanan</Link><StoreWhatsAppLink message="saya perlu bantuan cara order." className="inline-flex h-11 items-center rounded-full border border-white/10 bg-white/[0.06] px-6 text-sm font-semibold text-white">Tanya admin</StoreWhatsAppLink></div>
  </main>;
}
