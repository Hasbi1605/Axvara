...
export default function GaransiReplacePage() {
  return <main className="mx-auto max-w-[920px] px-4 py-10 sm:px-6 sm:py-14">
    ...
    <div className="mt-4 grid gap-4 lg:grid-cols-3">
      ...
      <section className="rounded-[22px] ax-glass-card p-5"><h2 className="font-semibold text-white">Masa garansi</h2><p className="mt-3 text-sm leading-6 text-white/55">Masa dan cakupan garansi mengikuti keterangan di deskripsi masing-masing produk. Terhitung sejak produk dikirim. Lewat masa aktif = hangus.</p><p className="mt-2 text-sm leading-6 text-white/55">Untuk produk yang <span className="text-white font-medium">dikerjakan sesuai antrean</span> (ditandai di halaman produk), masa garansi mulai berjalan saat detail akun diserahkan ke kamu — <span className="text-white font-medium">bukan</span> saat pembayaran. Waktu tunggu antrean tidak memotong masa garansi.</p></section>
    </div>
